...
ActiveRecord::Schema[7.2].define(version: 2024_09_20_104227) do
  ...
  create_table "project_status_changes", force: :cascade do |t|
    ...
    t.enum "current_status", null: false, enum_type: "project_status"
    t.bigint "project_id", null: false
    t.bigint "user_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "projects", force: :cascade do |t|
    t.string "name"
    t.enum "status", default: "not_started", null: false, enum_type: "project_status"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
